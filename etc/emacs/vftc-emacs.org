...
(vftc-emacs-builtin-package 'shell
  (setq shell-file-name (concat "/etc/profiles/per-user/" user-login-name "/bin/zsh")
...
*** Makefile
Run make targets interactively.

#+begin_src emacs-lisp
;;; Run make targets interactively (makefile-executor)
(vftc-emacs-manual-package 'makefile-executor
